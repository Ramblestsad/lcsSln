...
public sealed class TodoWebApiFactory: WebApplicationFactory<Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.UseSetting("ConnectionStrings:postgresWrite", "Host=localhost;Database=test-write;");
        builder.UseSetting("ConnectionStrings:postgresRead", "Host=localhost;Database=test-read;");
