...
//
// Just as in the previous problem, the given tree was constructed from a list a (root =
...
//
// Suppose b is a copy of a with the value val appended to it. It is guaranteed that b has unique
// values.
//
// Return Construct(b).
//
