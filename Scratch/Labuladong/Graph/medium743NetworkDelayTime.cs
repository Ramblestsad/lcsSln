...
// travel times as directed edges times[i] = (u_i, v_i, w_i), where u_i is the source node, v_i is
// the target node, and w_i is the time it takes for a signal to travel from source to target.
//
...
//
// Related Topics: Depth-First Search, Breadth-First Search, Graph Theory, Heap (Priority Queue), Shortest Path
