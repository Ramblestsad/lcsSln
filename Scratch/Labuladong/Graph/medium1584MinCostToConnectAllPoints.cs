...
//
// The cost of connecting two points [x_i, y_i] and [x_j, y_j] is the manhattan distance between
// them: |x_i - x_j| + |y_i - y_j|, where |val| denotes the absolute value of val.
//
